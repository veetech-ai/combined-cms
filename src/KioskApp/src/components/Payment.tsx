                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        {item.customization && Object.entries(item.customization).map(([key, value]) => (
                                            <span key={key} className="text-sm text-gray-500">• {value}</span>
                                        ))}
                                        {item.addons?.map((addon, idx) => (
                                            <span key={idx} className="text-sm text-gray-500">+ {addon.name} (${addon.price.toFixed(2)})</span>
                                        ))}
                                        {item.extras?.map((extra, idx) => (
                                            <span key={idx} className="text-sm text-gray-500">+ {extra.name} (${extra.price.toFixed(2)})</span>
                                        ))}
                                    </div>
                                </div>
                        ...
                        {items.map((item, index) => (
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-xl font-medium font-roboto">{item.name.en}</span>
                                        {item.customization && Object.entries(item.customization).map(([key, value]) => (
                                            <span key={key} className="text-sm text-gray-500">• {value}</span>
                                        ))}
                                        {item.addons?.map((addon, idx) => (
                                ...
                                <span className="text-xl font-bold font-roboto">${(item.price * item.quantity).toFixed(2)}</span>
                            </div>
                        ))}
                    </div>
                </div>
